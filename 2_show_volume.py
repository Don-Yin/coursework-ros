...
if __name__ == "__main__":
    ...
    print(entries_coords_in_array[0])  # tensor([ 59.7180, 125.6850,  31.2930], dtype=torch.float64)
    ...
    show_volume(images_itk["target_structure"], entries_coords_in_array, targets_coords_in_array, valid_path)
    show_volume(images_itk["critical_structure"], entries_coords_in_array, targets_coords_in_array, valid_path)
    show_volume(images_itk["cortex"], entries_coords_in_array, targets_coords_in_array, valid_path)
